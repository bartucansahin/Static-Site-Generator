...
class TestMarkdownConversion(unittest.TestCase):
    def test_paragraph_conversion(self):
        ...
        expected_html_node = HTMLNode("p", "This is a paragraph.", None, None)
    ...
    def test_code_block(self):
        ...
        expected_html_node = HTMLNode(
            tag="code",
            children=[LeafNode(tag="pre", value="print('Hello, World!')")]
        )
        self.assertEqual(html_node, expected_html_node)
    ...
    def test_heading(self):
        ...
        expected_html_node = HTMLNode(tag="h3", value="My Heading")
        self.assertEqual(html_node, expected_html_node)
