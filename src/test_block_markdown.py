...
class TestMarkdownConversion(unittest.TestCase):
    def test_paragraph_conversion(self):
        ...
        self.assertEqual(html_node[0].tag, expected_html.tag)
        self.assertEqual(html_node[0].children[0].value, expected_html.children[0].value)
    ...
    def test_unordered_list_conversion(self):
        ...
        self.assertEqual(html_node[0].tag, expected_html.tag)
        for i in range(len(html_node[0].children)):
            self.assertEqual(html_node[0].children[i].value, expected_html.children[i].value)
...
class TestMarkdownToHTMLNode(unittest.TestCase):
    def test_markdown_to_HTMLNode_complex(self):
        markdown = """This text has some **bold** text and 
        ...
        2. a link [alt text](www.bootdev.com)."""
